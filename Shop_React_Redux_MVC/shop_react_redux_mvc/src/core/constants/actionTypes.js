...
export const CATEGORIES_TYPES = {
    ...
    //single category
    CNTRL_GET_CATEGORY_BY_ID: 'CNTRL_GET_CATEGORY_BY_ID',
    RX_GET_CATEGORY_BY_ID: 'RX_GET_CATEGORY_BY_ID',
    RX_GET_CATEGORY_BY_ID_PENDING: 'RX_GET_CATEGORY_BY_ID_PENDING',
    RX_GET_CATEGORY_BY_ID_DONE: 'RX_GET_CATEGORY_BY_ID_DONE',
};
